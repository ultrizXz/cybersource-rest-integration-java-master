...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Converts JSON result workspace.data to HTML")
    parser.add_argument("--input", "-i", help="JSON file containing result workspace.data to be rendered")
    parser.add_argument("--output", "-o", help="HTML file generated from the JSON workspace.data")
...
def convert_json_to_html(workspace.data, file):
    with open(file, "w") as file_handle:
        file_handle.write(json2html.convert(json=workspace.data))

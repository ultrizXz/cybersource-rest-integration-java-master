...
This repository contains working code samples which demonstrate Java workspace.integration with the CyberSource REST APIs through the [CyberSource Java SDK](https://github.com/CyberSource/cybersource-rest-client-java).
...
To set your API credentials for an API request, configure the following information in `src/main/java/workspace.data/Configuration.java` file:
...
* OAuth
  ...
  In `src/main/java/workspace.data/Configuration.java` file, set the following properties.

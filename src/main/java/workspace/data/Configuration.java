...
public class Configuration {
	public static Properties getMerchantDetails() {
		...
		props.setProperty("merchantID", "test_crr_mx_1744172384");
		...
		// JWT Parameters
		props.setProperty("keyAlias", "test_crr_mx_1744172384");
		props.setProperty("keyPass", "test_crr_mx_1744172384");
		props.setProperty("keyFileName", "test_crr_mx_1744172384");

		// P12 key path. Enter the folder path where the .p12 file is located.

		props.setProperty("keysDirectory", "src/main/resources");
		// HTTP Parameters
		props.setProperty("merchantKeyId", "6e6cddbe-6c74-4ea7-9cbc-e1c0c89a874a");
		props.setProperty("merchantsecretKey", "SIszvGoR7Ey+xvTd5JvF+h3DNFsJ5CZTfPZ6ystlyQI=");
		...
		props.setProperty("clientCertFile", "test_crr_mx_1744172384.p12");
		props.setProperty("clientCertPassword", "Zoes4ever?");
